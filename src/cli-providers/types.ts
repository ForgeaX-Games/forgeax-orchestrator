// CliProvider — the abstraction over agent backends (@forgeax/orchestrator, the reference agent CLI,
...
export type ChatEvent = (
   ...
   * the original @forgeax/orchestrator-native event shape (ink-renderer-style
