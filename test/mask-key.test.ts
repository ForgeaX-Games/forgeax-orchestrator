...
// /api/settings returns secrets as first4 + eight stars + last4 so the UI can
// render a recognisable preview without exposing enough for theft. Short keys
// collapse to four stars. The Settings drawer parses these strings literally.
describe('maskKey()', () => {
  test('undefined → null', () => {
